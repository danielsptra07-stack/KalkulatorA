...
void hitungTurunan() {
    ...
    do {
        ...
        cout << "Terima kasih telah menggunakan fitur turunan!" << endl;
        cout << "\nIngin menghitung turunan lagi? (y/n): ";
        cin >> ulang;
...
void hitungIntegral() {
    ...
    do {
        double a;
        int n;
        cout << "\n=== PERHITUNGAN INTEGRAL TAK TENTU ===" << endl;
        cout << "Masukkan koefisien (a): ";
        cin >> a;
        cout << "Masukkan pangkat (n): ";
        cin >> n;
        ...
        cout << "Terima kasih telah menggunakan fitur integral tak tentu!" << endl;
        cout << "\nIngin menghitung integral lagi? (y/n): ";
        cin >> ulang;
    } while (ulang == 'y' || ulang == 'Y');
}
...
void hitungIntegralTentu() {
    ...
    do {
        ...
        cout << "Terima kasih telah menggunakan fitur integral tentu!" << endl;
        cout << "\nIngin menghitung integral tentu lagi? (y/n): ";
        cin >> ulang;
    } while (ulang == 'y' || ulang == 'Y');
}
...
void hitungPersamaanKuadrat() {
    ...
    do {
        ...
        cout << "Terima kasih telah menggunakan fitur persamaan kuadrat!" << endl;
        cout << "\nIngin menyelesaikan persamaan kuadrat lagi? (y/n): ";
        cin >> ulang;
    } while (ulang == 'y' || ulang == 'Y');
}
